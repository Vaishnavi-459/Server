...
const ServiceManagement = () => {
  ...
  const addTimeSlot = () => {
    ...
    const uniqueNewSlots = newSlots.filter((slot) => !timeSlots.includes(slot))
              ...
              <CCol md={6}>
                ...
                <CFormSelect
                  ...
                  onChange={(e) => {
                    ...
                    // Find the selected object for display or payload
          ...
          <CForm>
            <CRow className="mb-4">
              ...
              >
                ...
                {/* Add more service options below if needed */}
            ...
            <CRow className="mb-4">
              ...
              <CCol md={6}>
                ...
                <CFormInput
                  type="number"
                  placeholder="Discount"
                  value={serviceToEdit?.discountPercentage || ''}
                  onChange={(e) =>
                    setServiceToEdit({
                      ...serviceToEdit,
                ...
                {editErrors.discountPercentage && (
                  <CFormText className="text-danger">{editErrors.discountPercentage}</CFormText>
                )}
              </CCol>
            </CRow>
            ...
            {/* File Upload with File Name Preview */}
            <CRow className="mb-4">
              <CCol md={6}>
                <h6>Service Image</h6>
              ...
              {/* <CCol md={6}>
                ...
                {serviceToEdit?.bannerImageFile?.name && (
                  <CFormText>Selected: {serviceToEdit.bannerImageFile.name}</CFormText>
                )}
              </CCol> */}
            </CRow>
          </CForm>
